(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["3858c873e651bc3323baed2cb4dadac2"] = factory();
	else
		root["3858c873e651bc3323baed2cb4dadac2"] = factory();
})(this, function() {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_corespring_legacy_match_src_server_index__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_corespring_legacy_match_src_server_index___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_corespring_legacy_match_src_server_index__);
...
let createOutcome = (question, session) => {
  return __WEBPACK_IMPORTED_MODULE_0_corespring_legacy_match_src_server_index___default.a.createOutcome(question, session.value.answers, {
    showFeedback: true,
...
function outcome(question, session, env) {
  ...
  const completed = true; //optional, fake value
  const duration = "PT1M"; //optional, fake value, one minute, see https://en.wikipedia.org/wiki/ISO_8601#Durations
...
var feedbackUtils = __webpack_require__(4);
...
exports['corespring-match-ng15'] = __webpack_require__(2);
exports['corespring-match-ng15'].version =  '../node_modules/corespring-match-ng15/controller';
